...
- **Catatan minor**: konsol `/profil` memuat 2 error X-Frame-Options pada iframe peta (`/peta-majegan.html`) — perilaku lama, terpisah dari struktur; pantau bila audit responsif berikutnya.
