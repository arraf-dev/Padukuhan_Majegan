...
export default function Profil() {
  return (
    <div className="gap-10 px-4 py-8 md:grid md:grid-cols-[210px_1fr] md:px-12 md:pt-9 md:pb-12">
      ...
      <nav className="sticky top-5 mb-6 self-start max-md:hidden">
        ...
        <div className="flex flex-col border-l-2 border-garis">
          {bagian.map((b) => (
            <a
              key={b.id}
              href={`#${b.id}`}
              className="-ml-0.5 border-l-2 border-transparent px-3.5 py-2 text-[13.5px] text-redup hover:border-emas hover:font-bold hover:text-hutan"
            >
              {b.label}
            </a>
          ))}
      ...
      <div className="flex min-w-0 flex-col gap-10">
        <section id="sejarah" data-reveal className="scroll-mt-6">
          <JudulSection anak="Sejarah Padukuhan" />
          <div className="grid items-start gap-6 md:grid-cols-[1.5fr_1fr]">
            <div className="text-[15px] leading-[1.8] text-teks">
        ...
        <section id="visi-misi" data-reveal className="scroll-mt-6">
          <JudulSection
            anak="Visi & Misi"
            sisipan={
          ...
          <div className="grid gap-4.5 md:grid-cols-2">
            <div className="rounded-xl border-[1.5px] border-dashed border-garis-tebal bg-panel px-6 py-6 text-redup">
              <div className="mb-2.5 text-[11px] font-bold tracking-[.14em] text-emas-tua">VISI</div>
              <p className="font-serif text-[17px] leading-[1.65] font-medium text-pretty italic">
                {profil.visi}
              </p>
            </div>
            <div className="rounded-xl border-[1.5px] border-dashed border-garis-tebal bg-panel px-6 py-6 text-redup">
              <div className="mb-3 text-[11px] font-bold tracking-[.14em] text-emas-tua">MISI</div>
              <ol className="flex flex-col gap-2.5 text-sm leading-relaxed italic">
                {profil.misi.map((m, i) => (
        ...
        <section id="struktur" data-reveal className="scroll-mt-6">
            ...
            <div className="grid w-full grid-cols-2 gap-4 pt-5 md:grid-cols-4">
              {profil.perangkat.map((p) => (
                ...
                >
                  ...
                  <div className="text-[11.5px] font-semibold text-emas-tua">{p.jabatan}</div>
                </div>
              ))}
            </div>
        ...
        <section id="wilayah" data-reveal className="scroll-mt-6">
          <JudulSection anak="Wilayah & Kontak" />
          <div className="grid gap-6 md:grid-cols-[1.5fr_1fr]">
            <div className="flex flex-col gap-2">
              <div className="relative h-[230px] overflow-hidden rounded-xl border border-garis bg-foto">
                <iframe
            ...
            <address className="rounded-xl border border-garis bg-kertas px-6 py-5.5 text-[13.5px] leading-[1.75] text-teks not-italic">
              <div className="mb-2 font-serif text-base font-semibold text-hutan">
                Kantor Padukuhan
              </div>
              ...
              <a
                ...
                className="mt-3.5 inline-flex items-center gap-2 rounded-[9px] bg-daun px-4.5 py-2.5 text-[13.5px] font-bold text-krem transition hover:bg-hutan"
              >
